...
final class Version20221108090538 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $usersArray = array(
      array('name' => 'admin', 'password' => password_hash('admin', PASSWORD_DEFAULT), 'sexe' => 'Autre'),
      array('name' => 'florianFerbach', 'password' => password_hash('coucou', PASSWORD_DEFAULT), 'sexe' => 'Masculin'),
      array('name' => 'geromeCanals', 'password' => password_hash('test', PASSWORD_DEFAULT), 'sexe' => 'Masculin')
    );
    foreach ($usersArray as $userObject) {
      $this->addSql("INSERT INTO user (name_user, password_user, sexe_user) VALUES (:name, :password, :sexe)", $userObject);
    }
